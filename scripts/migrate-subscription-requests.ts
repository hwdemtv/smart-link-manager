    ...
    const foreignKeys = [
      {
        ...
        sql: "ALTER TABLE subscription_change_requests ADD CONSTRAINT fk_scr_requested_plan FOREIGN KEY (requestedPlanId) REFERENCES subscription_plans(id)",
      },
      {
        name: "fk_scr_current_plan",
        sql: "ALTER TABLE subscription_change_requests ADD CONSTRAINT fk_scr_current_plan FOREIGN KEY (currentPlanId) REFERENCES subscription_plans(id)",
      },
    ];
