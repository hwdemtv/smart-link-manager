  ...
  return (
    <div className="min-h-content bg-background">
      <div className="container py-4">
        <h1 className="text-xl font-bold tracking-tight mb-1">{t("common.analytics")}</h1>
        <p className="text-xs text-muted-foreground">{t("dashboard.analyticsSubtitle") || "实时追踪您的链接访问数据与趋势"}</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="p-4 border-accent-blue/10 bg-accent-blue/5">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs text-muted-foreground">{t("dashboard.totalLinks")}</p>
          ...
          <Card className="p-4 border-red-500/10 bg-red-500/5">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs text-muted-foreground">{t("dashboard.invalidLinks")}</p>
                <p className="text-2xl font-bold mt-1 text-destructive">{invalidLinks}</p>
              </div>
