...
LICENSE_SERVER_URLS=https://km.hwdemtv.com,https://kami.hwdemtv.com,https://hw-license-center.hwdemtv.workers.dev

# 鉴权过期回滚至的服务端校验地址
LICENSE_SERVER_URL=https://km.hwdemtv.com
```
*(注：代码中首选 `LICENSE_SERVER_URL`，如果存在多个 URL 地址需要前端或后端做多路回退封装可以依赖 `LICENSE_SERVER_URLS`)*
